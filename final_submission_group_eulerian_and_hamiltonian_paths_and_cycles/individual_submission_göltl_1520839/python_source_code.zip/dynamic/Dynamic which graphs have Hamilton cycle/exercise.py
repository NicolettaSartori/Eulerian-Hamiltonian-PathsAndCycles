...
from graphs import correct_graphs, wrong_graphs, correct_cycles, wrong_feedbacks
...
correct_with_marked_path = []
for i, g in enumerate(correct_graphs):
    correct_with_marked_path.append(nx_to_graphviz_with_marked_path(g, correct_cycles[i]))

correct_with_marked_path_datauris = [graphviz_to_svg_datauri(gv) for gv in correct_with_marked_path]
...
exercise_constants = [
    ...
    ("correct_with_marked_path_datauris", format_list(correct_with_marked_path_datauris)),
    ...
    ("correct_with_marked_path_datauri", "getFromList([var=correct_index], [var=correct_with_marked_path_datauris])"),
